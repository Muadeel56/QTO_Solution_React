      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col items-center">
            ...
            <p className="text-gray-600">QTO Available</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col items-center">
            ...
            <p className="text-gray-600">QTO In Progress</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col items-center">
            ...
            <p className="text-gray-600">Bid Results</p>
          </div>

          {/* Awarded */}
          <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col items-center">
            <FaTrophy className="text-yellow-500 text-4xl mb-2" />
            <p className="text-3xl font-bold text-gray-800">66</p>
            <p className="text-gray-600">Awarded</p>
          </div>
        </div>
      </div>
    </div>
