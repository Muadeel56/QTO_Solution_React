  ...
  return (
    <div className="relative w-full h-[60vh]">
      ...
      <div className="relative flex flex-col items-center justify-center h-full text-center px-4 md:px-10">
        ...
        <p className="text-lg md:text-2xl text-gray-200 max-w-3xl mb-8 drop-shadow-lg">
          "Empowering your project with detailed and accurate takeoff, simplifying estimation, and amplifying bidding success"
        </p>
        <button className="px-6 py-3 bg-yellow-500 text-gray-900 font-semibold rounded-lg shadow-lg hover:bg-yellow-600 transition-all duration-300 ease-in-out">
          Get Free Sample
        </button>
      </div>
    </div>
